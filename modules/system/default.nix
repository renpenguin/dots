...
in with lib; {
  ...
  config = mkMerge [
    ...
    (mkIf cfg.boot.enable {
      ...
      boot.kernelParams = [ "quiet" "loglevel=3" "amd_pstate=passive" ];
    ...
    (mkIf cfg.laptop.enable {
      ...
      services.logind.settings.Login = {
        ...
        HandlePowerKey = mkIf cfg.laptop.ignorePowerKey "ignore";
      };
    })
